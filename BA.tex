...
% makeindex BA.nlo -s nomencl.ist -o BA.nls
...
\newcommand{\titel}{Bahnoptimierung eines Industrieroboters zur Minimierung des Energieverbrauchs}
%\newcommand{\untertitel}{Identifikation von energetisch optimierten Via-Punkten zur Anpassung der Bahnplanung eines }
...
\newcommand{\betreuerdhbw}{Prof. Dr. Jochen M. Rieber}
...
\include{chapter/kurzfassung}			% Einbinden der eidestattlichen Erklärung
...
\renewcommand{\nomgroup}[1]{%
	\ifthenelse{\equal{#1}[a]}{\item[\textbf{Allgemeine Konventionen}]}{%
		\ifthenelse{\equal{#1}{b}}{\item[\textbf{Allgemeine Abkürzungen}]}{%
			\ifthenelse{\equal{#1}{d}}{\item[\textbf{Formelzeichen}]}{%
				\ifthenelse{\equal{#1}{e}}{\item[\textbf{Abkürzungen}]}{%
					\item[\\]}}}}}
...
\include{chapter/modellbildung}
\include{chapter/Bahnplanung}
\include{chapter/modellvalidierung}
\include{chapter/Optimierer}
\include{chapter/Validierung}
\include{chapter/Bewertung}
\include{chapter/ZusammenfassungAusblick}
