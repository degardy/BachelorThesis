...
\end{equation}
%
Die Bestimmung der Roboterdynamik setzt voraus, dass die berechnete Bewegungsbahn $\theta(t)$, sowie die dazugehörigen Verläufe $\dot{\theta}(t) ~\ddot{\theta}(t)$  die, von der KUKA Robotersteuerung berechnete Trajektorie möglichst genau approximieren. Die Abbildungen \ref{fig:gelenkwinkel}


werden die zeitlichen Verläufe der implementierten Trajektorien mit den, von der KUKA Robotersteuerung berechneten Bahnverläufen verglichen. Nachfolgend sind die Start- und Zielwinkel definiert. Die Implementierung ist im Anhang \ref{add:sim} hinterlegt.
%
