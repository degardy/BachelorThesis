...
\end{equation}
%
Die Berechnung der Roboterdynamik setz voraus, dass die Gelenkvariablen $\theta(t), ~\dot{\theta}(t) ~\ddot{\theta}(t)$ werden die zeitlichen Verläufe der implementierten Trajektorien mit den, von der KUKA Robotersteuerung berechneten Bahnverläufen verglichen. Nachfolgend sind die Start- und Zielwinkel definiert. Die Implementierung ist im Anhang \ref{add:sim} hinterlegt.
%
